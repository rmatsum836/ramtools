...
def calc_mol_number_density(trj, area,
        dim, box_range, n_bins, shift=True, frame_range=None, maxs=None, mins=None):
    """
    Calculate a molecule 1-dimensional number density profile for each residue using a COM trajectory
...
def calc_number_density(trj, area,
        dim, box_range, n_bins, shift=True, frame_range=None, maxs=None, mins=None):
    """
    Calculate an atomistic 1-dimensional number density profile for each residue using a COM trajectory
    ...
    rho = np.divide(rho, trj.n_frames*area*(bins[1]-bins[0]))
